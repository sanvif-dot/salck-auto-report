...
load_dotenv('/Users/sanvi/Documents/project-1/automate_reports/plugins/send_to_slack/.env')
...
if __name__ == '__main__':
    execute('trial', '#auto_report', 'output/sales_per_month.png', file=None, file_type=None, title=None)
